...
<main>
      ...
      <tbody>
        ...
        <tr class="content">
          <td colspan="4">안녕하세요. 뉴렉처입니다.
            ...
            <div>
              <a href="http://www.newlecture.com/resource/spring2.zip"><b> <font size="5" color="#dd8a00">예제 다운로드하기</font>
                </b></a>
            </div>
            <div>
              <br>
  ...
  <div class="margin-top text-align-center">
    <a class="btn-text btn-cancel" href="list.html">목록</a> <a class="btn-text btn-default" href="edit.html">수정</a> <a class="btn-text btn-default" href="del.html">삭제</a>
  </div>
